...
void showSymptomsListButtomsheet(ctxt) {
              ...
              children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Align(
                            ...
                            alignment: Alignment.topLeft,
                            child: Text(AppStrings.today.tr,style: AppTxtStyles.getAppRegularFont(
                                size: 16.sp, fontWeight: FontWeight.w400),
                            )),
                      ),
                    ),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        AppStrings.moderateSeverity.tr,
                        style: AppTxtStyles.getAppRegularFont(
                            size: 16.sp, fontWeight: FontWeight.w400),
                      ),
                      Checkbox(
